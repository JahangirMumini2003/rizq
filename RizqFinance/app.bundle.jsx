...
function S03Solution() {
  ...
  const steps = [
    { n: "01", screen: 0, t: "Подключаем компанию", b: "Компания регистрируется в ЛК. KYB-верификация, документы, страховой депозит 17.5% ФОТ, электронный договор.", tags: ["KYB", "Депозит 17.5% ФОТ", "1–3 дня"] },
...
function S04bRizq() {
  const tasks = [
    ...
    { n: "02", icon: <Icon.building/>, t: "Onboarding & KYB", b: "Верификация компании, документы, юридическое оформление, страховой депозит 17.5% ФОТ, электронные договоры." },
    ...
    { n: "07", icon: <Icon.shield/>, t: "Гарантия возврата · NPL = 0", b: "Payroll-backed модель: депозит 17.5% ФОТ + удержание из зарплаты в день выплаты. Невозвратов нет." },
        ...
        <div style={{ marginTop: 48 }}>
          ...
          <div style={{
            ...
            {[
              ...
              { n: "03", h: "Rahn", sh: "Обеспечение", b: "Страховой депозит компании (17.5% ФОТ) — залог. Допустимый инструмент обеспечения в исламских финансах." },
    ...
    <section style={{ background: "var(--bg-sand)", color: "var(--ink)" }}>
      <div className="container">
        <SecHead
          ...
          title={<>Почему <span className="display-serif" style={{color:"var(--ink-2)"}}>МФО</span>, а не факторинг.</>}
        ...
        <div style={{
          ...
          <div className="card" style={{
            padding: 26, borderRadius: 18,
            background: "var(--card)",
            border: "1px solid oklch(0.78 0.10 25 / 0.4)",
            position: "relative", overflow: "hidden",
          }}>
            <span style={{
              fontFamily: "var(--f-mono)", fontSize: 10, fontWeight: 800,
              color: "oklch(0.52 0.18 25)", letterSpacing: "0.14em", textTransform: "uppercase",
            }}>Иллюзия факторинга</span>
            <h3 style={{ marginTop: 12, fontSize: 22, color: "var(--ink)", letterSpacing: "-0.02em", lineHeight: 1.25 }}>
          ...
          <div className="card" style={{
            ...
            <div aria-hidden style={{
              ...
              background: "radial-gradient(circle, oklch(0.78 0.24 142 / 0.16), transparent 70%)",
            }}/>
            <span style={{
              position: "relative",
              fontFamily: "var(--f-mono)", fontSize: 10, fontWeight: 800,
            ...
            <h3 style={{ position: "relative", marginTop: 12, fontSize: 22, color: "var(--ink)", letterSpacing: "-0.02em", lineHeight: 1.25 }}>
            ...
            <p style={{
              position: "relative",
              marginTop: 14, padding: "10px 14px", borderRadius: 10,
              background: "oklch(0.78 0.24 142 / 0.14)",
              border: "1px solid var(--brand)",
              fontSize: 12.5, color: "var(--ink)", lineHeight: 1.55,
            }}>
              <b style={{ color: "var(--brand-2)" }}>Что получаем:</b> своя выдача со своего баланса, любой банк как канал (не блокер), полная маржа ($3.10 ujra → 100% Rizq), доступ к шариатскому комплаенсу де-юре.
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          {rows.map(([param, fac, mfo], i) => (
            <div key={i} style={{
              ...
              padding: "16px 22px",
              borderTop: "1px solid var(--line)",
              background: i % 2 === 0 ? "var(--card)" : "oklch(0.97 0.014 86)",
