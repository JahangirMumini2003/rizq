...
function S03Solution() {
  ...
  const steps = [
    ...
    { n: "06", screen: 7, t: "Rizq финансирует перевод", b: "Rizq выдаёт средства на карту сотрудника из собственного баланса по МФО-лицензии ЦБ Узбекистана. Это не кредит сотруднику — операция, обеспеченная payroll-гарантией работодателя и страховым покрытием.", tags: ["МФО · ЦБ УЗ", "NPL = 0", "Payroll-backed"] },
    ...
    <section style={{ background: "var(--bg-deep)", color: "var(--inverse)", position: "relative", overflow: "hidden" }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <PathBlock
          ...
          gets={[
            { t: "25% в Rizq", b: "С лицензией МФО ЦБ Узбекистана — самостоятельный финтех-актив." },
      ...
      <div className="container" style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
        ...
        <Reveal delay={200}>
          <p style={{
            ...
            Раунд открыт. $300K · 25% equity · МФО-лицензия ЦБ Узбекистана.
